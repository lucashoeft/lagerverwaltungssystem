    ...
    void readInventoryFromFileWithContent() {
        assertDoesNotThrow(() -> {
            ...
            String content =
                    ...
                    "Prod-4,Kat3,24,001003,375,799\n" + // unknown category used -> add category and article
                    ...
                    "fehler-art-18,Kat1,0,001016,1,9999901\n" + // price to high -> ignore
                     // "fehler-art-19,Kat1,1,000017,1,1\n" + // shelf 000 overloaded -> ignore  (known error)
            ...
            Assertions.assertEquals(5, myInventory.getItemMap().size());
            ...
            // TODO Assertions.assertEquals(100000000, myInventory.getShelfMap().get(0).getWeight()); // because of known error for "fehler-art-19" above
            ...
            // check categories
            Assertions.assertEquals(5, myInventory.getCategoryMap().size());
            ...
            Assertions.assertEquals(1, myInventory.getCategoryMap().get("Kat3").getCount());
            Assertions.assertEquals(0, myInventory.getCategoryMap().get("Kat4").getCount());
