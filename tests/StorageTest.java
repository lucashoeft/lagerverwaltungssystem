...
class StorageTest {
    ...
    void updateStorageContent() {
        ...
        Assertions.assertTrue(myStorage.addItemToStorage(new InventoryItem("item11", "cat1", 0, "001001", 10, 199), 100));
        ...
        Assertions.assertTrue(myStorage.addItemToStorage(new InventoryItem("item12", "cat1", 0, "001002", 20, 199), 100));
        Assertions.assertEquals(3, myStorage.getShelfMap().size());
        ...
        Assertions.assertTrue(myStorage.addItemToStorage(new InventoryItem("item21", "cat1", 0, "002001", 20, 199), 1000));
        Assertions.assertEquals(3, myStorage.getShelfMap().size());
        Assertions.assertEquals(10 * 100 + 20 * 100, myStorage.getShelfMap().get(1).getWeight());
        Assertions.assertEquals(2, myStorage.getShelfMap().get(2).getId());
        ...
        Assertions.assertTrue(myStorage.addItemToStorage(new InventoryItem("item31", "cat1", 0, "003001", 1 * 1000 * 1000, 199), 10));
        Assertions.assertEquals(3, myStorage.getShelfMap().size());
        Assertions.assertEquals(10 * 100 + 20 * 100, myStorage.getShelfMap().get(1).getWeight());
        Assertions.assertEquals(2, myStorage.getShelfMap().get(2).getId());
        Assertions.assertEquals(20 * 1000, myStorage.getShelfMap().get(2).getWeight());
        ...
        Assertions.assertFalse(myStorage.addItemToStorage(new InventoryItem("item32", "cat1", 0, "003002", 1, 199), 1)); // adding 1g exceeds weight limit
        Assertions.assertEquals(3, myStorage.getShelfMap().size());
        ...
        Assertions.assertTrue(myStorage.removeItemFromStorage(new InventoryItem("item31", "cat1", 10, "003001", 10 * 1000 * 1000, 199), 1)); // remove one item
        Assertions.assertEquals(3, myStorage.getShelfMap().size());
        Assertions.assertEquals(10 * 100 + 20 * 100, myStorage.getShelfMap().get(1).getWeight());
        Assertions.assertEquals(2, myStorage.getShelfMap().get(2).getId());
        Assertions.assertEquals(20 * 1000, myStorage.getShelfMap().get(2).getWeight());
        ...
        Assertions.assertTrue(myStorage.addItemToStorage(new InventoryItem("item32", "cat1", 0, "003002", 1, 199), 1)); // adding 1g now allowed
        Assertions.assertEquals(3, myStorage.getShelfMap().size());
        Assertions.assertEquals(10 * 100 + 20 * 100, myStorage.getShelfMap().get(1).getWeight());
        Assertions.assertEquals(2, myStorage.getShelfMap().get(2).getId());
        Assertions.assertEquals(20 * 1000, myStorage.getShelfMap().get(2).getWeight());
        ...
        Assertions.assertTrue(myStorage.addItemToStorage(new InventoryItem("item41", "cat1", 0, "004001", 1, 199), 10)); // new shelf required
        ...
        Assertions.assertTrue(myStorage.removeItemFromStorage(new InventoryItem("item41", "cat1", 10, "004001", 10, 199), 1));
        Assertions.assertEquals(4, myStorage.getShelfMap().size());
        Assertions.assertEquals(10 * 100 + 20 * 100, myStorage.getShelfMap().get(1).getWeight());
        Assertions.assertEquals(2, myStorage.getShelfMap().get(2).getId());
        Assertions.assertEquals(20 * 1000, myStorage.getShelfMap().get(2).getWeight());
        ...
        Assertions.assertFalse(myStorage.removeItemFromStorage(new InventoryItem("item41", "cat1", 9, "004001", 1, 199), 10)); // can not remove more than in stock
        Assertions.assertEquals(4, myStorage.getShelfMap().size());
        Assertions.assertEquals(10 * 100 + 20 * 100, myStorage.getShelfMap().get(1).getWeight());
        Assertions.assertEquals(2, myStorage.getShelfMap().get(2).getId());
        Assertions.assertEquals(20 * 1000, myStorage.getShelfMap().get(2).getWeight());
        ...
        Assertions.assertFalse(myStorage.removeItemFromStorage(new InventoryItem("item51", "cat1", 10, "005001", 1, 199), 1)); // remove not existing item
